...
export default class GeometryZ {
  constructor() {
    ...
    this.cube1 = new Cube({x:0,y:1,z:0}, this.color)
    this.cube2 = new Cube({x:1,y:1,z:0}, this.color)
    this.cube3 = new Cube({x:1,y:0,z:0}, this.color)
    this.cube4 = new Cube({x:2,y:0,z:0}, this.color) 
